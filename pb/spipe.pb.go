...
func (*Propose) Descriptor() ([]byte, []int) { return fileDescriptorSpipe, []int{0} }
...
func (*Exchange) Descriptor() ([]byte, []int) { return fileDescriptorSpipe, []int{1} }
...
func init() { proto.RegisterFile("spipe.proto", fileDescriptorSpipe) }

var fileDescriptorSpipe = []byte{
